  ...
  return <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="scroll-animate opacity-0 transform translate-y-8">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 border border-purple-200 dark:border-purple-700/50 mb-8 shadow-sm hover:shadow-md transition-all duration-300">
              ...
              <span className="text-sm font-medium text-purple-700 dark:text-purple-300">Saving you weeks of development time
            </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              ...
              <Button variant="outline" size="lg" className="text-lg px-10 py-4 border-2 border-slate-300 dark:border-slate-600 hover:border-purple-300 dark:hover:border-purple-600 hover:bg-purple-50 dark:hover:bg-purple-950/20 transition-all duration-300 backdrop-blur-sm">
                Watch Demo
              </Button>
            </div>
      ...
      <section id="features" className="py-24 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          }].map((feature, index) => <Card key={index} className="scroll-animate opacity-0 transform translate-y-8 hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden border-0 bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm" style={{
